...
ABV = st.slider ('Choose the alcohol percentage of your wine',0.0,100.0,float(yourData['ABV'].mean()),0.1)

st.write("""
         ***
         """)
     
Rating = st.slider ('Choose the rating according to vivino',0.0,5.0,float(yourData['VivinoRating'].mean()),0.1)

st.write("""
         ***
         """)
       
Bold = st.slider ('Choose the bold level (use Vivino)',1.0,10.0,float(yourData['Bold'].mean()),0.5) 
Tannic = st.slider ('Choose the tannic level (use Vivino)',1.0,10.0,float(yourData['Tannic'].mean()),0.5)
Sweet = st.slider ('Choose the sweetness (use Vivino)',1.0,10.0,float(yourData['Sweet'].mean()),0.5)  
Acidic = st.slider ('Choose the acidity level (use Vivino)',1.0,10.0,float(yourData['Acidic'].mean()),0.5) 
